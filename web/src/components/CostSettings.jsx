...
export default function CostSettings({ items, rates, onItem, onRate, onReset }) {
      ...
      <div className="cost-head">
        <div>
          ...
          <p className="cost-intro">
            Set the unit material and installation cost for every catalogue item. Changes flow
            through every facility package, branch estimate and the exported Bill of Materials in real time.
          </p>
        </div>
